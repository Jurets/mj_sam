<?php
// include base renderer classes
require_once($CFG->dirroot.'/course/renderer.php');
require_once($CFG->dirroot.'/lib/gradelib.php');

// class for course rendering
class theme_anomaly_core_course_renderer extends core_course_renderer {
    /**
...
// class for grade report rendering
/*class theme_anomaly_gradereport_user_renderer extends gradereport_user_renderer {
