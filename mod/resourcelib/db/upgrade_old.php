...
function xmldb_resourcelib_upgrade($oldversion) {
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field intro to be added to resourcelib.
        $table = new xmldb_table('resourcelib');
        ...
        // Define field introformat to be added to resourcelib.
        $table = new xmldb_table('resourcelib');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'resourcelib');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to resourcelib.
        $table = new xmldb_table('resourcelib');
        ...
        // Define field timemodified to be added to resourcelib.
        $table = new xmldb_table('resourcelib');
        ...
        // Define index course (not unique) to be added to resourcelib.
        $table = new xmldb_table('resourcelib');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'resourcelib');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'resourcelib');
    }
