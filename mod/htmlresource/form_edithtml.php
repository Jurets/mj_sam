...
class mod_htmlresource_form_editvideo extends moodleform {
    public function definition() {
        ...
        $mform->addElement('text', 'video_id', get_string('videoid', 'htmlresource'), array('style'=>'width: 100%')); // Add elements to your form
        $mform->setType('video_id', PARAM_TEXT);                   //Set type of element
        $mform->addRule('video_id', get_string('missing_videoid', 'htmlresource'), 'required', null, 'client');
        ...
        //video: Video Title
        $mform->addElement('text', 'title', get_string('video_title', 'htmlresource'), array('style'=>'width: 100%')); // Add elements to your form
        ...
        //video: Podcast URL
        $mform->addElement('text', 'podcast_url', get_string('podcast_url', 'htmlresource'), array('style'=>'width: 100%')); // Add elements to your form
        $mform->setType('podcast_url', PARAM_TEXT);  
        //video: transcript
        $mform->addElement('textarea', 'transcript', get_string('transcript', 'htmlresource'), array('rows'=>3, 'style'=>'width: 100%'));
