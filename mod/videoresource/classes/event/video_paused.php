...
class video_paused extends \core\event\base
{
    ...
    public static function get_name() {
        return get_string('eventvideopaused', 'videoresource');
    }
 
    // get description of logged event (used for the page /report/log/index.php)
    public function get_description() {
        return 'The user with id '.$this->userid.' pause the video of VideoResource (id: '.$this->objectid.').';
    }
