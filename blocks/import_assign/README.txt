...
* Rename the import_assign/ folder to the name of your module (eg "widget").
...
all the instances of the string "import_assign" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/import_assign/widget/g' {} \;

* Rename the file lang/en/import_assign.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_import_assign.php
...
and you should find that this import_assign has been added to the list of
installed modules.
